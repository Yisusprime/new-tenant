...
import { ServerSideUploader } from "@/components/server-side-uploader"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"

export default function ServerSideUploadPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 p-4 md:p-8 overflow-auto w-full">
        <div className="mb-6">
          <h1 className="text-2xl md:text-3xl font-bold">Subida de Imágenes (Servidor)</h1>
          <p className="text-muted-foreground">
            Esta versión evita problemas CORS usando el servidor como intermediario
          </p>
        </div>
