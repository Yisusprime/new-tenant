...
import { GeneralSettings } from "@/components/theme/general-settings"
import { ColorSettings } from "@/components/theme/color-settings"
import { ImageSettings } from "@/components/theme/image-settings"
import { DisplaySettings } from "@/components/theme/display-settings"
import { ContactSettings } from "@/components/theme/contact-settings"
import { PaymentServiceSettings } from "@/components/theme/payment-service-settings"
      ...
      <div className="flex-1 p-4 md:p-6 overflow-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Tabs defaultValue="general">
              <TabsList className="mb-4">
                ...
                <TabsTrigger value="payment">Pagos y Servicios</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="colors" className="space-y-4">
                <ColorSettings tenantData={tenantData} handleInputChange={handleInputChange} />
              </TabsContent>
              ...
              <TabsContent value="display" className="space-y-4">
                <DisplaySettings tenantData={tenantData} handleOpacityChange={handleOpacityChange} />
              </TabsContent>
          ...
          <div className="hidden lg:block">
            <PreviewPanel previewTab={previewTab} setPreviewTab={setPreviewTab} tenantData={tenantData} />
          </div>
        </div>
      </div>
    </div>
