    ...
    <div>
      ...
      <Alert className="mb-6 bg-blue-50 border-blue-200">
        ...
        <AlertDescription className="text-blue-700">
          En esta versión de demostración, puedes cambiar entre planes sin necesidad de pago. En un entorno de
          producción, se integraría con un sistema de pagos.
        </AlertDescription>
      </Alert>
          ...
          return (
            <Card key={planType} className={isCurrentPlan ? "border-primary" : ""}>
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      {planConfig.maxBranches === -1
                        ...
                        : `Hasta ${planConfig.maxBranches} sucursal${planConfig.maxBranches !== 1 ? "es" : ""}`}
                    </span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-green-500 mr-2 shrink-0" />
              ...
              <CardFooter>
                ...
                >
                  {isCurrentPlan ? "Plan Actual" : isUpdating ? "Actualizando..." : "Seleccionar Plan"}
                </Button>
              </CardFooter>
            </Card>
          )
